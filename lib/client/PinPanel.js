...
function PinnedSectionContent({ pinnedRecords, sessions, current, onOpen, onUnpin, t, }) {
    ...
    if (pinned.length === 0)
        return null;
    return (_jsxs("div", { className: C.section, role: "group", "aria-label": t("section.aria"), children: [_jsxs("div", { className: C.sectionHeader, onClick: () => setCollapsed((c) => !c), role: "treeitem", "aria-expanded": !collapsed, children: [_jsx("span", { className: C.sectionIcon, children: _jsxs("svg", { width: "14", height: "14", viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true", children: [_jsx("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M8.5 1.5C7.4 1.5 6.5 2.4 6.5 3.5V5L4 7.5C3.6 7.9 3.6 8.5 4 8.9L5.1 10L3.2 11.9C2.9 12.2 2.9 12.7 3.2 13C3.5 13.3 4 13.3 4.3 13L6.2 11.1L7.3 12.2C7.7 12.6 8.3 12.6 8.7 12.2L11.2 9.7C11.6 9.3 11.6 8.7 11.2 8.3L9.5 6.6V3.5C9.5 2.4 9.1 1.5 8.5 1.5Z", fill: "currentColor" }), _jsx("path", { d: "M8 12.5V15", stroke: "currentColor", "stroke-width": "1.3", "stroke-linecap": "round" })] }) }), _jsx("span", { className: C.sectionTitle, children: t("title") }), _jsx("span", { className: C.sectionCount, children: pinned.length })] }), !collapsed && (_jsx("div", { className: C.sectionBody, children: pinned.map((s) => {
                    ...
                    return (_jsxs("div", { className: `${C.row} ${s.isCurrent ? C.rowSelected : ""} ${menuOpenId === s.id ? C.rowMenuOpen : ""}`, role: "treeitem", "aria-selected": s.isCurrent, onClick: () => onOpen(s.id), onKeyDown: (e) => {
