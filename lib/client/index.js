...
export async function apply(ctx) {
    ...
    ctx.effect(() => {
        ...
        const getSessionId = (row) => {
            ...
            while (fiber) {
                ...
                if (props?.node?.id && typeof props.node.id === "string")
        ...
        const onPointerDown = (e) => {
            ...
            if (!aria.includes("会话") && !aria.toLowerCase().includes("session action"))
                return;
        ...
        const observer = new MutationObserver(() => {
            ...
            for (const menu of document.querySelectorAll('div[role="menu"]')) {
                ...
                if (menu.querySelector("[data-pin-sessions-menu-item]"))
                    continue;
                ...
                if (iconSpan)
                    iconSpan.innerHTML = isPinned ? UNPIN_SVG : PIN_SVG;
    ...
    ctx.effect(() => {
        ...
        const check = () => {
            ...
            if (current === undefined || current === lastCurrent)
                return;
            lastCurrent = current;
